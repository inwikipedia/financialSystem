        ...
        j.prototype.config = {
            ...
            j.prototype.render = function() {
                ...
                if (a.elem = t(a.elem), a.where = a.where || {},
                    a.id = a.id || a.elem.attr("id") || a.index, a.request = t.extend({
                        pageName: "page",
                        limitName: "limit"
                    },
                ...
                if (i.startTime = (new Date).getTime(), a.url) {
                    ...
                    function lal_t(){
                        t.ajax({
                            ...
                            dataType: "json",
                            headers: a.headers || {},
                            success: function (backt) {
                                //如果请求页大于总页数，重新渲染下一页
                                if(backt.data && backt.data.pageCount && backt.data.pageNo && backt.data.pageCount < backt.data.pageNo && backt.data.pageNo != 1){
                                    if(r[l.pageName]){
                                        r[l.pageName] = r[l.pageName]-1;
                                        d = t.extend(r, a.where);
                                        a.contentType && 0 == a.contentType.indexOf("application/json") && (d = JSON.stringify(d)),lal_t()
                                        return;
                                    }

                                }
                                if(backt.data && backt.data.count && backt.data.page && Math.ceil(backt.data.count/backt.data.size) < backt.data.page && backt.data.page != 1){
                                    if(r[l.pageName]){
                                        r[l.pageName] = r[l.pageName]-1;
                                        d = t.extend(r, a.where);
                                        a.contentType && 0 == a.contentType.indexOf("application/json") && (d = JSON.stringify(d)),lal_t()
                                ...
                                "function" == typeof a.parseData && (backt = a.parseData(backt) || backt), backt[n.statusName] != n.statusCode ? (i.renderForm(), i.layMain.html('<div class="' + h + '">' + (backt[n.msgName] || "返回的数据不符合规范，正确的成功状态码 (" + n.statusName + ") 应为：" + n.statusCode) + "</div>")) : (i.renderData(backt, e, backt[n.countName]), o(), a.time = (new Date).getTime() - i.startTime + " ms"), i.setColsWidth(), "function" == typeof a.done && a.done(backt, e, backt[n.countName])
                            },
                            error: function (e, backt) {
                                i.layMain.html('<div class="' + h + '">数据接口请求异常：' + backt + "</div>"), i.renderForm(), i.setColsWidth()
                            }
                        })
                    }
                    a.contentType && 0 == a.contentType.indexOf("application/json") && (d = JSON.stringify(d)),lal_t();
                        ...
                        t.ajax({
                            ...
                            success: function(t) {
                                "function" == typeof a.parseData && (t = a.parseData(t) || t),
                                    t[n.statusName] != n.statusCode ? (i.renderForm(), i.layMain.html('<div class="' + h + '">' + (t[n.msgName] || "返回的数据不符合规范，正确的成功状态码 (" + n.statusName + ") 应为：" + n.statusCode) + "</div>")) : (i.renderData(t, e, t[n.countName]), o(), a.time = (new Date).getTime() - i.startTime + " ms"),
                                    i.setColsWidth(),
            ...
            j.prototype.renderData = function(e, n, o, r) {
                            ...
                            function(a, l) {
                                ...
                                0 !== l.length && (r || (l[d.config.indexName] = a), c.eachCols(function(n, r) {
                                    ...
                                    if (void 0 !== p && null !== p || (p = ""), !r.colGroup) {
                                        var v = ['<td data-field="' + c + '" data-key="' + f + '" ' +
                                        function() {
                                            var e = [];
                                        ...
                                        function() {
                                            ...
                                            return r.toolbar ? i(t(r.toolbar).html() || "").render(n) : r.templet ?
                                                function() {
                                                    return "function" == typeof r.templet ? r.templet(n, r) : i(t(r.templet).html() || String(p)).render(n)
                                                } () : p
                                        } (), "</div></td>"].join("");
                                        o.push(v),
                ...
                return c.key = s.id || s.index,
                    ...
                    r ? m() : 0 === u.length ? (c.renderForm(), c.layFixed.remove(), c.layMain.find("tbody").html(""), c.layMain.find("." + h).remove(), c.layMain.append('<div class="' + h + '">' + s.text.none + "</div>")) : (m(), c.renderTotal(u), void(s.page && (s.page = t.extend({
            ...
            j.prototype.renderTotal = function(e) {
                ...
                if (i.totalRow) {
                    ...
                    t.eachCols(function(e, t) {
                        var n = t.field || e;
                        if (!t.hide) {
                            var o = ['<td data-field="' + n + '" data-key="' + t.key + '" ' +
                            function() {
                                var e = [];
            ...
            j.prototype.sort = function(e, i, a, l) {
                ...
                c.sortKey = {
                    ...
                    "asc" === i ? r = layui.sort(f, n) : "desc" === i ? r = layui.sort(f, n, !0) : (r = layui.sort(f, d.config.indexName), delete c.sortKey),
                ...
                a.layBody.on("click", "." + g,
                    function() {
                        var e = t(this),
                            i = e.parent(),
                            n = i.children(f);
                        a.tipsIndex = l.tips(['<div class="layui-table-tips-main" style="margin-top: -' + (n.height() + 16) + "px;" +
                        function() {
