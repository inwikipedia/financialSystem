...
var KisBpmProcessIdPropertyCtrl = [ '$rootScope','$scope', function ($rootScope,$scope) {

    //console.log($scope.property);

    if ($scope.property.value == "未定义") {

        //var timestamp = new Date().getTime();

        //$scope.property.value = "a"+timestamp.toString();
        $scope.property.value = $rootScope.modelData.model.properties.process_id;
        //$scope.property.value = $rootScope.modelData.name;
    }
...
var KisBpmStringPropertyCtrl = [ '$scope', function ($scope) {
    ...
    /**/
    /*$scope.showMeTheDetails = function () {
