                ...
                function renderParsedFormat(parsedFormat, date1, date2, separator, isRTL) {
                    ...
                    if (middleStr1 || middleStr2) {
                        if (isRTL) {
                            ...
                            middleStr = middleStr1+"日" + separator + middleStr2;
                        }
                    }
                ...
                var Toolbar = /** @class */ (function() {
                    ...
                    Toolbar.prototype.render = function() {
                        ...
                        if (sections) {
                            ...
                            el.append('<div style="float:left;color: #181818;font-size: 16px;font-weight: bold;"><img src="./assetsInfo/images/firstpage/rc.png" style="margin-top: 2px;margin-right: 7px;">日程<div>')
                            el.append(this.renderSection('left'))
                                .append(this.renderSection('right'))
                                .append(this.renderSection('center'))
                                .append('<div class="fc-clear"/>');
                                console.log(this.renderSection('left'))
                        } else {
                            this.removeElement();
                        }
                    };
