 ...
 * 
 */
var GC = GC || {}; GC["Spread"] = GC["Spread"] || {}; GC["Spread"]["CalcEngine"] = GC["Spread"]["CalcEngine"] || {}; GC["Spread"]["CalcEngine"]["AdvancedFunctions"] =
...
/***/ (function(module, exports, __webpack_require__) {
	...
	(function() {
	    ...
	    var functions = __webpack_require__(1).Functions;
...
/***/ (function(module, exports, __webpack_require__) {
	...
	(function() {
	    ...
	    var RegexHelper = Common._RegexHelper, keyword_null = null;
	    var CalcConvert = Calc.Convert, CalcConvert_toDouble = CalcConvert._toDouble;
	    var CalcConvert_isNumber = CalcConvert._isNumber, CalcConvert_isError = CalcConvert._isError,
	        CalcConvert_toResult = CalcConvert._toResult;
	    var CalcErrors = Calc.Errors, CalcErrorsDivideByZero = CalcErrors.DivideByZero, CalcErrorsValue = CalcErrors.Value;
	    var Functions = Calc.Functions, defineBuiltInFunction = Functions._defineBuiltInFunction,
	        isString = Functions._isString, isNanFunc = isNaN;
	    ...
	    var Exp_InvalidCast = sR().Exp_InvalidCast;
	    ...
	    CriteriaEvaluator.prototype._evaluate = function (databaseValue) {
	        ...
	        var result = Calc.evaluateOperator(map[this._criteriaOperator], databaseValue, this._criteriaValue);
	        return Functions._isBoolean(result) ? CalcConvert._toBool(result) : false;
	    };
	    ...
	    DatabaseEnumerator.prototype = {
	        _columnIndex: function (database, field) {
	            if (isString(field)) {
	                for (var i = 0; i < database.colCount; i++) {
	                    var columnLabel = CalcConvert._toString(database[0][i]);
	            ...
	            return CalcConvert._toInt(field) - 1;
	        },
	        _current: function () {
	            var self = this;
	            if (self._row <= 0 || self._database.rowCount <= self._row) {
	                throw sR().Exp_InvalidOperation;
	            }
	        ...
	        _createEvaluator: function (criteria) {
	            if (isString(criteria)) {
	                ...
	                var criteriaText = CalcConvert._toString(criteria), i;
	                var matchLength;
	                for (i = 0; i < databaseEnumeratorOperators.length; i++) {
	                    if (Common._StringHelper._startsWith(criteriaText, databaseEnumeratorOperators[i])) {
	                        criteriaText = criteriaText.substring(databaseEnumeratorOperators[i].length);
	                        var criteriaDouble = Common._NumberHelper._parseInvariant(criteriaText);
	                            ...
	                            if (isString(value) && isString(databaseValue)) {
	                                ...
	                                if (wildcardCriteria) {
	                                    ...
	                                    if (matchLength) { 
	                                        ...
	                                        pass = StringHelper_StartWith(value, databaseValue, true);
	                                    }
	                                }
	                                continue;
	                            }
	        ...
	        _ignoreCaseEqual: function (stringOne, stringTwo) {
	    ...
	    function db_daverage(database, field, criteria) {
	        ...
	        while (enumerator._moveNext()) {
	            ...
	            if (CalcConvert_isNumber(obj)) {
	                var d = {value: 0};
	                if (!CalcConvert._tryToDouble(obj, d)) {
	                    return CalcErrorsValue;
	                }
	                sum += d.value;
	                n++;
	    ...
	    function db_dmax(database, field, criteria) {
	        var isAny = false, max = -Functions._MAX_DOUBLE_VALUE;
	        var enumerator = new DatabaseEnumerator(database, field, criteria);
	        while (enumerator._moveNext()) {
	            var obj = enumerator._current();
	            if (CalcConvert_isError(obj)) {
	    ...
	    function db_dmin(database, field, criteria) {
	        var any = false, min = Functions._MAX_DOUBLE_VALUE;
	        var enumerator = new DatabaseEnumerator(database, field, criteria);
	        while (enumerator._moveNext()) {
	            var obj = enumerator._current();
	            if (CalcConvert_isError(obj)) {
	    ...
	    var acceptsNotOne = '!= 1';
	    var arrayArgDefaultValue = {_acceptsRealValue: true, _argType: 4 , _valueType: 0 },
	        acceptsRealValueDefaultValue = {_acceptsRealValue: true};
...
/***/ (function(module, exports, __webpack_require__) {
	...
	(function () {
	    ...
	    var arrayHelper_getLength = Common._ArrayHelper._getLength;
	    var keyword_undefined = void 0, Math_abs = Math.abs, Math_sin = Math.sin,
	        Math_cos = Math.cos, Math_sqrt = Math.sqrt, Math_log = Math.log, Math_pow = Math.pow,
	        Math_exp = Math.exp, Math_E = Math.E, Math_atan2 = Math.atan2;
	    var parseFloatFunc = parseFloat, isNaNFunc = isNaN;
	    var CalcErrors = Calc.Errors, CalcErrorsNotAvailable = CalcErrors.NotAvailable, CalcErrorsNumber = CalcErrors.Number, CalcErrorsValue = CalcErrors.Value;
	    var Functions = Calc.Functions, defineBuiltInFunction = Functions._defineBuiltInFunction,
	        st_normsdist = Functions._st_normsdist;
	    var CalcConvert = Calc.Convert, CalcConvert_toResult = CalcConvert._toResult;
	    var MathHelper = Functions._MathHelper, sinhCosh = MathHelper._sinhCosh;
	    var Complex = Functions._Complex, convertToComplex = Functions._convertToComplex;
	    var BIT_LIMIT_NUMBER = 281474976710655;
	    var COMPLEX_ONE = new Complex(1.0, 0.0);
	    var _tryToDouble = CalcConvert._tryToDouble;
	    ...
	    function getEngUnitsArray(unitArray, valueArray) {
	        ...
	        for (i = 0; i < arrayHelper_getLength(unitArray); i++) {
	            retValue.push(new Eng_convert_unit_t(unitArray[i], valueArray[i]));
	        }
	        retValue.push(new Eng_convert_unit_t(null, 0));
	        return retValue;
	    }
	    ...
	    var weightUnits = getEngUnitsArray(['g', 'sg', 'lbm', 'u', 'ozm'],
	        [1, 0.00006852205001, 0.002204622915, 6.02217e+23, 0.035273972]);
	    ...
	    var distanceUnits = getEngUnitsArray(['m', 'mi', 'Nmi', 'in', 'ft', 'yd', 'ang', 'Pica', 'km'],
	        [1, one_m_to_mi, 1 / 1852.0, one_m_to_in, one_m_to_ft, one_m_to_yd, 1e10, 2834.645669, 0.001]);
	    ...
	    var timeUnits = getEngUnitsArray(['yr', 'day', 'hr', 'mn', 'sec'],
	        [1, one_yr_to_day, one_yr_to_hr, one_yr_to_mn, one_yr_to_sec]);
	   
	   
	    var one_Pa_to_mmHg = 0.00750061708;
	    var pressureUnits = getEngUnitsArray(['Pa', 'atm', 'mmHg', 'p', 'at'],
	        [1, 0.9869233e-5, one_Pa_to_mmHg, 1, one_Pa_to_mmHg]);
	   
	   
	    var one_N_to_dyn = 100000;
	    var forceUnits = getEngUnitsArray(['N', 'dyn', 'lbf', 'dy'],
	        [1, one_N_to_dyn, 0.224808924, one_N_to_dyn]);
	   
	    var one_HP_to_W = 745.701;
	    var powerUnits = getEngUnitsArray(['HP', 'W', 'h', 'w'], [1, one_HP_to_W, 1, one_HP_to_W]);
	    ...
	    var energyUnits = getEngUnitsArray(['J', 'e', 'c', 'cal', 'eV', 'HPh', 'Wh', 'flb', 'BTU', 'ev', 'hh', 'wh', 'btu'],
	        [1, 9999995.193, 0.239006249, 0.238846191, one_J_to_eV, one_J_to_HPh, one_J_to_Wh, 23.73042222, one_J_to_BTU, one_J_to_eV, one_J_to_HPh, one_J_to_Wh, one_J_to_BTU]);
	   
	   
	    var magnetismUnits = getEngUnitsArray(['T', 'gs'], [1, 10000]);
	    ...
	    var one_tsp_to_l = 0.0049289216;
	    var liquidUnits = getEngUnitsArray(['tsp', 'tbs', 'oz', 'cup', 'pt', 'qt', 'gal', 'l', 'uk_pt', 'us_pt', 'lt'],
	        [1, 1 / 3, 1 / 6, 1 / 48, 1 / 96, 1 / 192, 1 / 768, one_tsp_to_l, 0.008675585, 1 / 96, one_tsp_to_l]);
	    ...
	    var prefixes = getEngUnitsArray(['Y', 'Z', 'E', 'P', 'T', 'G', 'M', 'k', 'h', 'e', 'd', 'c', 'm', 'u', 'n', 'p', 'f', 'a', 'z', 'y'],
	        [1e+24, 1e+21, 1e+18, 1e+15, 1e+12, 1e+09, 1e+06, 1e+03, 1e+02, 1e+01, 1e-01, 1e-02, 1e-03, 1e-06, 1e-09, 1e-12, 1e-15, 1e-18, 1e-21, 1e-24]);
	    ...
	    function bessel(num, order, modfied) {
	        ...
	        var N1 = Functions._fact(order), N2 = 1.0, n1 = 0.0, n2 = parseFloatFunc(order), act = Z / N1, old = act * 0.9;
	        var addFlag = false;
	    ...
	    function eg_binHexOct2dec(number, radix) {
	        ...
	        return arrayHelper_getLength(result) < arrayHelper_getLength(number) ? CalcErrorsNumber : result;
	    }
	    ...
	    function eg_transformNumber(number, places, radix1, radix2, maxValue) {
	        ...
	        if (arrayHelper_getLength(temp) < arrayHelper_getLength(number)) {
	            return CalcErrorsNumber;
	        }
	    ...
	    function eg_imProductSum(args, isProduct) {
	        ...
	        for (i = 0; i < arrayHelper_getLength(args); i++) {
	            if (CalcConvert._isArray(args[i])) {
	                var array = args[i];
	            ...
	            } else if (CalcConvert._isReference(args[i])) {
	                var ref = args[i];
	        ...
	        return convertResultToComplex(new Complex(real, imag));
	    }
	    ...
	    function eg_bessely(xValue, nValue) {
	        ...
	        function y0_y1(x, isY0) {
	            ...
	            w = 5 / x;
	            z = isY0 ? 25 / (x * x) : w * w;
	            var p = polevl_p1evl(z, PP, 6) / polevl_p1evl(z, PQ, 6),
	                q = polevl_p1evl(z, QP, 7) / polevl_p1evl(z, QQ, 7, true),
	                xn = x - (isY0 ? PIO4 : THPIO4);
	    ...
	    function eg_delta(num1, num2) {
	        return Calc._Helper._approxEqual(num1, num2) ? 1 : 0;
	    }
	    ...
	    function eg_complex(real, imag, suffix) {
	        ...
	        return convertResultToComplex(new Complex(real, imag), suffix);
	    }
	    ...
	    function eg_imconjugate(num) {
	        return convertResultToComplex(new Complex(num._real, -num._imag));
	    }
	
	    function eg_imcos(num) {
	        return convertResultToComplex(new Complex(Math_cos(num._real) * sinhCosh(num._imag, false), -Math_sin(num._real) * sinhCosh(num._imag, true)));
	    }
	    ...
	    function eg_imdiv(num0, num1) {
	        ...
	        var c = num1._real;
	        var d = num1._imag;
	        return convertResultToComplex(new Complex((a * c + b * d) / (c * c + d * d), (b * c - a * d) / (c * c + d * d)));
	    }
	
	    function eg_imexp(num) {
	        return convertResultToComplex(new Complex(Math_exp(num._real) * Math_cos(num._imag), Math_exp(num._real) * Math_sin(num._imag)));
	    }
	
	    function eg_imln(num) {
	        var x = num._real;
	        var y = num._imag;
	        return convertResultToComplex(new Complex(Math_log(Math_sqrt(x * x + y * y)), Math_atan2(y, x)));
	    }
	    ...
	    function eg_imlog10(num) {
	        ...
	        return convertResultToComplex(new Complex(log10e * Math_log(Math_sqrt(x * x + y * y)), log10e * Math_atan2(y, x)));
	    }
	    ...
	    function eg_imlog2(num) {
	        ...
	        return convertResultToComplex(new Complex(log2e * Math_log(Math_sqrt(x * x + y * y)), log2e * Math_atan2(y, x)));
	    }
	    ...
	    function eg_impower(num, pow) {
	        ...
	        return convertResultToComplex(new Complex(Math_pow(abs, pow) * Math_cos(pow * phi), Math_pow(abs, pow) * Math_sin(pow * phi)));
	    }
	    ...
	    function eg_imsin(num) {
	        return convertResultToComplex(new Complex(Math_sin(num._real) * sinhCosh(num._imag, false), Math_cos(num._real) * sinhCosh(num._imag, true)));
	    }
	    ...
	    function eg_imsqrt(num) {
	        ...
	        var abs = Math_sqrt(x * x + y * y);
	        var phi = Math_atan2(y, x);
	        return convertResultToComplex(new Complex(Math_sqrt(abs) * Math_cos(phi / 2), Math_sqrt(abs) * Math_sin(phi / 2)));
	    }
	
	    function eg_imsub(num0, num1) {
	        return convertResultToComplex(new Complex(num0._real - num1._real, num0._imag - num1._imag));
	    }
	    ...
	    function fixPrefixes(unitName) {
	        ...
	        for (var i = 0; FIX_PREFIXED_LIST[i]._str; i++) {
	            if (unitName.localeCompare(FIX_PREFIXED_LIST[i]._str) === 0) {
	                return false;
	            }
	        }
	        return true;
	    }
	    function getConstantOfUnit(units, prefixesArray, unit_name) {
	        var i, _c = 0, _prefix = 1;
	        for (i = 0; units[i]._str; i++) {
	            if ((unit_name.localeCompare(units[i]._str)) === 0) {
	                _c = units[i]._c;
	                return {
	                    _hasUnit: true,
	                    _prefix: _prefix,
	        ...
	        if (prefixesArray) {
	            for (i = 0; prefixesArray[i]._str; i++) {
	                ...
	                var p = prefixesArray[i]._str.substr(0, 1).toLowerCase();
	                if ((u === p) && fixPrefixes(unit_name)) {
	                    _prefix = prefixesArray[i]._c;
	                }
	            }
	        }
	        for (i = 0; units[i]._str; i++) {
	            var length = arrayHelper_getLength(units[i]._str);
	            var u1 = unit_name.substr(1, length);
	            var u2 = units[i]._str.substr(0, length);
	            if ((u1 === u2) && fixPrefixes(unit_name)) {
	                _c = units[i]._c;
	                return {
	                    _hasUnit: true,
	                    _prefix: _prefix,
	    ...
	    function eg_convert(n, from_unit, to_unit) {
	        function isSameString(stringValue, ch) {
	        ...
	        var isCelsiusDegreeFromUnit = isSameString(from_unit, 'C') || isSameString(from_unit, 'cel'),
	            isCelsiusDegreeToUnit = isSameString(to_unit, 'C') || isSameString(to_unit, 'cel'),
	            isFahrenheitFromUnit = isSameString(from_unit, 'F') || isSameString(from_unit, 'fah'),
	            isFahrenheitToUnit = isSameString(to_unit, 'F') || isSameString(to_unit, 'fah'),
	            isKelvinFromUnit = isSameString(from_unit, 'K') || isSameString(from_unit, 'kel'),
	            isKelvinToUnit = isSameString(to_unit, 'K') || isSameString(to_unit, 'kel');
	        if (isCelsiusDegreeFromUnit && isCelsiusDegreeToUnit || isFahrenheitFromUnit && isFahrenheitToUnit || isKelvinFromUnit && isKelvinToUnit) {
	            return n;
	        }
	        if (isCelsiusDegreeFromUnit && isFahrenheitToUnit) {
	            return n * 9 / 5 + 32;
	        }
	        if (isFahrenheitFromUnit && isCelsiusDegreeToUnit) {
	            return (n - 32) * 5 / 9;
	        }
	        if (isFahrenheitFromUnit && isKelvinToUnit) {
	            return (n - 32) * 5 / 9 + C_K_OFFSET;
	        }
	        if (isKelvinFromUnit && isFahrenheitToUnit) {
	            return (n - C_K_OFFSET) * 9 / 5 + 32;
	        }
	        if (isCelsiusDegreeFromUnit && isKelvinToUnit) {
	            return n + C_K_OFFSET;
	        }
	        if (isKelvinFromUnit && isCelsiusDegreeToUnit) {
	            return n - C_K_OFFSET;
	        }
	        var unitsArray = [weightUnits, distanceUnits, timeUnits, pressureUnits, forceUnits, energyUnits, powerUnits, magnetismUnits, liquidUnits, magnetismUnits];
	    ...
	    function eg_imcot(text) {
	        return getComplexText(text, function (complex) {
	            if (complexEquals(complexSin(complex), new Complex(0, 0))) {
	                return CalcErrorsNumber;
	            }
	    ...
	    function eg_imcsc(text) {
	        return getComplexText(text, function (complex) {
	            if (complexEquals(complex, new Complex(0, 0))) {
	                return CalcErrorsNumber;
	            }
	    ...
	    function eg_imcsch(text) {
	        return getComplexText(text, function (complex) {
	            if (complexEquals(complexSinh(complex), new Complex(0, 0))) {
	                return CalcErrorsNumber;
	            }
	    ...
	    function eg_imsec(text) {
	        return getComplexText(text, function (complex) {
	            if (complexEquals(complexCos(complex), new Complex(0, 0))) {
	                return CalcErrorsNumber;
	            }
	    ...
	    function eg_imsech(text) {
	        return getComplexText(text, function (complex) {
	            if (complexEquals(complexCosh(complex), new Complex(0, 0))) {
	                return CalcErrorsNumber;
	            }
	    ...
	    function complexSin(value) {
	        ...
	        return new Complex(Math_sin(real) * sinhCosh(imaginary, false), Math_cos(real) * sinhCosh(imaginary, true));
	    }
	
	    function complexCos(value) {
	        var real = value._getReal();
	        var imaginary = value._getImag();
	        return new Complex(Math_cos(real) * sinhCosh(imaginary, false), -(Math_sin(real) * sinhCosh(imaginary, true)));
	    }
	
	    function complexSinh(value) {
	        var real = value._getReal();
	        var imaginary = value._getImag();
	        return new Complex(sinhCosh(real, true) * Math_cos(imaginary), sinhCosh(real, false) * Math_sin(imaginary));
	    }
	
	    function complexCosh(value) {
	        var real = value._getReal();
	        var imaginary = value._getImag();
	        return new Complex(sinhCosh(real, false) * Math_cos(imaginary), sinhCosh(real, true) * Math_sin(imaginary));
	    }
	    ...
	    var doubleArgDefaultValue = {_argType: 0 },
	        stringArgDefaultValue = {_argType: 5 },
	        stringArgDefaultValue1 = {_argType: 5 , _argCondition: ['checkLength 10']},
	        stringArgDefaultValue2 = {
	            _needArgExistsValue: true,
	            _argType: 2 ,
	            _defaultValue: 1,
	            _argCondition: ['< 1', '> 10']
	        },
	        stringArgDefaultValue3 = {_argType: 2 , _argCondition: '< 0'},
	        complexArgDefaultValue = {_argType: 8 },
	        complexArgDefaultValue1 = {_argType: 8 , _complexCondition: true};
	    var engArgsLimitDefaultValue = [doubleArgDefaultValue, stringArgDefaultValue3],
	        engArgsLimitDefaultValue1 = [{_argType: 0 , _argCondition: '<= 0'}, stringArgDefaultValue3],
	        engArgsLimitDefaultValue2 = [doubleArgDefaultValue, {_argType: 0 , _defaultValue: 0}],
	        engArgsLimitDefaultValue3 = [stringArgDefaultValue1, stringArgDefaultValue2];
	    ...
	    defineBuiltInFunction('BIN2HEX', eg_bin2hex, 1, 2, engArgsLimitDefaultValue3,
	        keyword_undefined, keyword_undefined, {_acceptsMissingArgument: 1});
	    defineBuiltInFunction('BIN2OCT', eg_bin2oct, 1, 2, engArgsLimitDefaultValue3,
	        keyword_undefined, keyword_undefined, {_acceptsMissingArgument: 1});
	    ...
	    defineBuiltInFunction('DEC2HEX', eg_dec2hex, 1, 2,
	        [{_argType: 0 , _argCondition: ['< -549755813888', '> 549755813887']}, stringArgDefaultValue2],
	        keyword_undefined, keyword_undefined, {_acceptsMissingArgument: 1});
	    defineBuiltInFunction('DEC2OCT', eg_dex2oct, 1, 2,
	        [{_argType: 0 , _argCondition: ['< -536870912', '> 536870911']}, stringArgDefaultValue2],
	        keyword_undefined, keyword_undefined, {_acceptsMissingArgument: 1});
	    defineBuiltInFunction('HEX2BIN', eg_hex2bin, 1, 2, engArgsLimitDefaultValue3,
	        keyword_undefined, keyword_undefined, {_acceptsMissingArgument: 1});
	    defineBuiltInFunction('HEX2DEC', eg_hex2dec, 1, 1, stringArgDefaultValue1);
	    defineBuiltInFunction('HEX2OCT', eg_hex2oct, 1, 2, engArgsLimitDefaultValue3,
	        keyword_undefined, keyword_undefined, {_acceptsMissingArgument: 1});
	    defineBuiltInFunction('OCT2BIN', eg_oct2bin, 1, 2, engArgsLimitDefaultValue3,
	        keyword_undefined, keyword_undefined, {_acceptsMissingArgument: 1});
	    defineBuiltInFunction('OCT2DEC', eg_oct2dec, 1, 1, stringArgDefaultValue1);
	    defineBuiltInFunction('OCT2HEX', eg_oct2hex, 1, 2, engArgsLimitDefaultValue3,
	        keyword_undefined, keyword_undefined, {_acceptsMissingArgument: 1});
	    ...
	    defineBuiltInFunction('DELTA', eg_delta, 1, 2, engArgsLimitDefaultValue2, keyword_undefined, keyword_undefined,
	        {_acceptsMissingArgument: 1});
	    defineBuiltInFunction('GESTEP', eg_gestep, 1, 2, engArgsLimitDefaultValue2, keyword_undefined, keyword_undefined,
	        {_acceptsMissingArgument: 1});
	    defineBuiltInFunction('COMPLEX', eg_complex, 2, 3,
	        [doubleArgDefaultValue, doubleArgDefaultValue, {_argType: 5 , _defaultValue: 'i'}],
	    ...
	    defineBuiltInFunction('CONVERT', eg_convert, 3, 3,
	        [{_argType: 1 }, stringArgDefaultValue, stringArgDefaultValue]);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	(function () {
	    ...
	    var isFiniteFunc = isFinite;
	    var Types = Common._Types, inArray = Types._inArray, isArray = Types._isArray,
	        isNullOrUndefined = Types._isNullOrUndefined, arrayHelper_getLength = Common._ArrayHelper._getLength;
	    var CalcConvert = Calc.Convert, CalcConvert_toInt = CalcConvert._toInt, CalcConvert_isError = CalcConvert._isError,
	        CalcConvert_toResult = CalcConvert._toResult, CalcConvert_toArray = CalcConvert._toArray,
	        CalcConvert_toDouble = CalcConvert._toDouble, CalcConvertedError = CalcConvert.CalcConvertedError;
	    var keyword_null = null, keyword_undefined = void 0,
	        Math_pow = Math.pow, Math_abs = Math.abs, Math_ceil = Math.ceil, Math_log = Math.log,
	        Math_sqrt = Math.sqrt, Math_floor = Math.floor, Math_max = Math.max, Math_min = Math.min;
	    var CalcErrors = Calc.Errors, CalcErrorsDivideByZero = CalcErrors.DivideByZero, CalcErrorsValue = CalcErrors.Value,
	        CalcErrorsNumber = CalcErrors.Number;
	    var Functions = Calc.Functions, defineBuiltInFunction = Functions._defineBuiltInFunction;
	    var MathHelper = Functions._MathHelper, MathHelper_round = MathHelper._round;
	    var MAX_DOUBLE_VALUE = Functions._MAX_DOUBLE_VALUE, annualYearBasis = Functions._annualYearBasis,
	        getDaysInMonth = Functions._getDaysInMonth, compareDateTime = Functions._compareDateTime,
	        daysBetweenBasis = Functions._daysBetweenBasis, yearfrac = Functions._yearfrac;
	    var _tryToDouble = CalcConvert._tryToDouble;
	    ...
	    function convertToOADate(date) {
	        return date instanceof Date ? Common._DateTimeHelper._toOADate(date) : date;
	    }
	    ...
	    function daysMonthlyBasis(date_i, date_m, basis) {
	        ...
	        var retValue = -1;
	        if (basis === 0) {
	            retValue = Functions._days360(date_i, date_m);
	    ...
	    function coupnum(settlement, maturity, freq) {
	        ...
	        return parseInt((1 + months / (12 / freq)).toString());
	    }
	    ...
	    function dateRatio(d1, d2, d3, freq, basis) {
	        var next_coupon = coupCd(d1, d3, freq, true),
	            prev_coupon = coupCd(d1, d3, freq, false);
	    ...
	    function calcPrice(settlement, maturity, rate, yieldParam, redemption, freq, basis) {
	        var a = coupdaybs(settlement, maturity, freq, basis),
	            ...
	            n = parseInt((coupnum(settlement, maturity, freq)).toString()),
	            sum = 0.0,
	            den = 100.0 * rate / freq,
	        ...
	        var first_term = redemption / Math_pow(based, (n - 1.0 + d / e)),
	            last_term = a / e * den;
	    ...
	    function calcOddfprice(settlement, maturity, rate, yieldParam, redemption, freq, basis, issue, first_coupon) {
	        ...
	        var n = parseInt((coupnum(settlement, maturity, freq)).toString());
	        ...
	        if (ds > e) {
	            switch (basis) {
	                ...
	                case 4:
	                    ...
	                    n = 1 + parseInt((Math_ceil(cdays / e)).toString());
	                    break;
	                default:
	                    ...
	                    for (n = 0; n < 32767 ; n++) {
	                        ...
	                        if (compareDateTime(d, maturity) >= 0) {
	                            n += parseInt((Math_ceil(daysBetweenBasis(prev_date, maturity, basis)) / coupdays(prev_date, d, freq, basis)).toString()) + 1;
	                            break;
	                        }
	                    }
	        ...
	        var term1 = redemption / Math_pow(f, n - 1.0 + ds / e),
	    ...
	    function calcOddlyield(isPrice, settlement, maturity, last_interest, rate, redemption, freq, basis, priceOrYield) {
	        ...
	        var x1 = dateRatio(last_interest, settlement, d, freq, basis),
	            x2 = dateRatio(last_interest, maturity, d, freq, basis),
	            x3 = dateRatio(settlement, maturity, d, freq, basis);
	    ...
	    function _irr_npv(rate, vals, isDF) {
	        var n = arrayHelper_getLength(vals);
	        var sum = 0.0, i;
	        for (i = 0; i < n; i++) {
	            sum += (isDF ? -i : 1) * vals[i] * Math.pow(1 + rate, -i - 1 - (isDF ? 1 : 0));
	        }
	        return sum;
	    }
	    ...
	    function _fake_df(fakeDfFlag, func, x, dfx, xstep, data, settleOrValues, maturityOrDates, rate, price, redemption, freq, basis, issue, first_coupon) {
	        ...
	        } else {                result1 = _rate_f(xl, yl, settleOrValues);
	    ...
	    function _xirr_goal_seek_point(data, x0, values, y, dates) {
	        if (x0 < data._xmin || x0 > data._xmax) {
	            return [false, data, y];
	        }
	        ...
	        resultArray = updateData(x0, 0, data);
	        data = resultArray[1];
	        return [!!resultArray[0], data, y];
	    }
	    ...
	    function _goal_seek_newton(isXirr, calcFunc, data, x0, settleOrValues, maturityOrDates, rate, price, redem, freq, basis, issue, first_coupon) {
	        ...
	        for (iterations = 0; iterations < 20; iterations++) {
	            ...
	            var temp = data._havexneg && data._havexpos ? Math_abs(data._xpos - data._xneg) : (data._xmax - data._xmin),
	                xstep = (Math_abs(x0) < 1.0e-10 ? temp : Math_abs(x0)) / 1.0e6, df0 = 0.0;
	    ...
	    function _irr_goal_seek_newton(data, vals, x0) {
	        var iterations;
	    ...
	    function _rate_replaceGoto(data, user_data, stepsize, newton_submethod, ymid, method) {
	        ...
	        if (method === 1) {
	            ...
	            if (temp === 0) {
	                ...
	                resultArray = _rate_f(x0, y0, user_data);
	                user_data = resultArray[2];
	                y0 = resultArray[1];
	                status = resultArray[0];
	                if (!status) {
	    ...
	    function fi_npv(rate) {
	        var args = arguments;
	        var npvResult = 0.0, i = 1, j, k;
	        for (k = 1; k < arrayHelper_getLength(args); k++) {
	            var valueArray = CalcConvert_toArray(args[k], 1 , true, true, false);
	    ...
	    function fi_received(settlement, maturity, investment, discount, basis) {
	        ...
	        var a = daysMonthlyBasis(settlement, maturity, basis),
	            d = annualYearBasis(settlement, basis);
	        if (a <= 0 || d <= 0) {
	            return CalcErrorsNumber;
	        }
	    ...
	    function fi_ppmt(rate, per, nper, pv, fv, type) {
	        ...
	        var pmt = calculatePmt(rate, nper, pv, fv, type);
	        return pmt - calculateInterestPart(pv, pmt, rate, per - 1.0);
	    }
	    ...
	    function fi_irr(a1, guess) {
	        ...
	        data._xmax = Math_min(data._xmax, Math_pow(MAX_DOUBLE_VALUE / 1.0e10, 1.0 / len) - 1);
	        for (var j = 0; j < len; j++) {
	            var obj = a1[j];
	        ...
	        if (!status) {
	            for (factor = 2; !(data._havexneg && data._havexpos) && factor < 100; factor *= 2) {
	                data = _goal_seek_point(true, keyword_undefined, data, guess * factor, vals)[1];
	                data = _goal_seek_point(true, keyword_undefined, data, guess / factor, vals)[1];
	            }
	            resultArray = _odd_goal_seek_bisection(true, data, vals);
	            data = resultArray[1];
	            status = resultArray[0];
	        }
	        return status ? data._root : CalcErrorsNumber;
	    ...
	    function fi_xirr(values, dates, guess) {
	        ...
	        var data = {
	            _xmin: -1, _xmax: 1000, _precision: 1e-10, _havexpos: false, _xpos: 0, _ypos: 0,
	            _havexneg: false, _xneg: 0, _yneg: 0, _root: 0
	        };
	        ...
	        for (i = 1; i <= 1024; i += i) {
	            ...
	            var resultArray2 = _xirr_goal_seek_point(data, guess, y, values, dates);
	            data = resultArray2[1];
	            y = ii;
	            resultArray2 = _xirr_goal_seek_point(data, guess, y, values, dates);
	            data = resultArray2[1];
	            var resultArray3 = _goal_seek_bisection(false, true, data, values, dates);
	            data = resultArray3[1];
	    ...
	    function fi_rate(nper, pmt, pv, fv, type, guess) {
	        ...
	        var data = {
	            _precision: 1e-10, _havexpos: false, _xpos: 0, _ypos: 0, _havexneg: false, _xneg: 0, _yneg: 0, _root: 0
	        }, temp = Math_pow(1.7976931348623158e+298, 1.0 / nper);
	        data._xmin = Math_max(-1e10, -temp + 1.0);
	        data._xmax = Math_min(1e10, temp - 1.0);
	    ...
	    function fi_accrint(maturity, first_interest, settlement, rate, par, freq, basis) {
	        ...
	        for (i = 0; i < freq; i++) {
	            var next = i === freq - 1 ? 0 : i + 1;
	            var nextYear = months[next] > months[i] ? 2001 : 2002;
	    ...
	    function fi_accrint1(maturity, first_interest, settlement, rate, par, freq, basis) {
	        var a = daysMonthlyBasis(maturity, settlement, basis),
	            d = annualYearBasis(maturity, basis);
	    ...
	    function fi_accrintm(issue, maturity, rate, par, basis) {
	        ...
	        var a = daysMonthlyBasis(issue, maturity, basis),
	            d = annualYearBasis(issue, basis);
	        return (a < 0 || d <= 0) ? CalcErrorsNumber : par * rate * a / d;
	    }
	    ...
	    function fi_disc(settlement, maturity, par, redemption, basis) {
	        ...
	        var b = annualYearBasis(settlement, basis),
	            dsm = daysMonthlyBasis(settlement, maturity, basis);
	    ...
	    function fi_pricemat(settlement, maturity, issue, rate, yld, basis) {
	        ...
	        var dsm = daysMonthlyBasis(settlement, maturity, basis),
	            dim = daysMonthlyBasis(issue, maturity, basis),
	            a = daysMonthlyBasis(issue, settlement, basis),
	            b = annualYearBasis(settlement, basis);
	    ...
	    var doubleArgDefaultValue = {_argType: 0 },
	        doubleArgDefaultValue1 = {_defaultValue: 0, _argType: 0 },
	        doubleArgDefaultValue2 = {_argType: 0 , _argCondition: '<= 0'},
	        doubleArgDefaultValue3 = {_argType: 0 , _argCondition: '< 1'},
	        doubleArgDefaultValue4 = {_argType: 0 , _argCondition: '< 0'},
	        doubleArgDefaultValue5 = {_defaultValue: 0.1, _argType: 0 },
	        doubleArgDefaultValue6 = {_defaultValue: 2, _argType: 0 },
	        doubleArgDefaultValue7 = {_argType: 0 , _argCondition: '= 0'},
	        doubleArgDefaultValue8 = {_defaultValue: 1000, _argType: 0 , _argCondition: '<= 0'};
	    ...
	    var stringIntArgDefaultValue = {_argType: 2 },
	        stringIntArgDefaultValue1 = {_argType: 2 , _argCondition: '<= 0'},
	        stringIntArgDefaultValue2 = {_argType: 2 , _argCondition: '< 1'},
	        stringIntArgDefaultValue3 = {_defaultValue: 0, _argType: 2 },
	        stringIntArgDefaultValue4 = {_defaultValue: 0, _argType: 2 , _argCondition: ['< 0', '> 4']},
	        stringIntArgDefaultValue5 = {_defaultValue: 0, _argType: 2 , _argCondition: ['< 0', '> 4', '= 2']},
	        stringIntArgDefaultValue6 = {
	            _argType: 2 ,
	            _argCondition: '= 0',
	    ...
	    var finArgsLimitDefaultValue = [dateTimeArgDefaultValue, dateTimeArgDefaultValue, stringIntArgDefaultValue,
	        ...
	        finArgsLimitDefaultValue1 = [dateTimeArgDefaultValue, dateTimeArgDefaultValue, doubleArgDefaultValue,
	            doubleArgDefaultValue, stringIntArgDefaultValue, stringIntArgDefaultValue4],
	        finArgsLimitDefaultValue2 = [dateTimeArgDefaultValue, dateTimeArgDefaultValue, doubleArgDefaultValue2],
	        finArgsLimitDefaultValue3 = [doubleArgDefaultValue, dateTimeArgDefaultValue, dateTimeArgDefaultValue,
	            doubleArgDefaultValue, stringIntArgDefaultValue, doubleArgDefaultValue2, stringIntArgDefaultValue5],
	        finArgsLimitDefaultValue4 = [doubleArgDefaultValue, doubleArgDefaultValue, doubleArgDefaultValue,
	            doubleArgDefaultValue1, doubleArgDefaultValue1],
	        finArgsLimitDefaultValue5 = [dateTimeArgDefaultValue, dateTimeArgDefaultValue, doubleArgDefaultValue2,
	            doubleArgDefaultValue2, stringIntArgDefaultValue4],
	        finArgsLimitDefaultValue6 = [doubleArgDefaultValue2, stringIntArgDefaultValue1,
	            doubleArgDefaultValue2, stringIntArgDefaultValue2, stringIntArgDefaultValue, stringIntArgDefaultValue],
	        finArgsLimitDefaultValue7 = [doubleArgDefaultValue2, stringIntArgDefaultValue2],
	        finArgsLimitDefaultValue8 = [doubleArgDefaultValue, stringIntArgDefaultValue7];
	
	   
	    defineBuiltInFunction('FV', fi_fv, 3, 5, finArgsLimitDefaultValue4, keyword_undefined, keyword_undefined,
	    ...
	    defineBuiltInFunction('PV', fi_pv, 3, 5, finArgsLimitDefaultValue4, keyword_undefined, keyword_undefined,
	        {_acceptsMissingArgument: [3, 4]});
	    defineBuiltInFunction('RECEIVED', fi_received, 4, 5, finArgsLimitDefaultValue5, keyword_undefined, keyword_undefined,
	        {_acceptsMissingArgument: 3});
	    defineBuiltInFunction('XNPV', fi_xnpv, 3, 3, [doubleArgDefaultValue, arrayArgDefaultValue1, arrayArgDefaultValue1],
	        '!= 0', '!= 0');
	    ...
	    defineBuiltInFunction('IPMT', fi_ipmt, 4, 6, [doubleArgDefaultValue, doubleArgDefaultValue3, doubleArgDefaultValue3,
	            doubleArgDefaultValue, doubleArgDefaultValue1, stringIntArgDefaultValue3],
	        keyword_undefined, keyword_undefined, {_acceptsMissingArgument: [4, 5]});
	    ...
	    defineBuiltInFunction('PMT', fi_pmt, 3, 5, [doubleArgDefaultValue,
	            ...
	            doubleArgDefaultValue, doubleArgDefaultValue1, doubleArgDefaultValue1],
	    ...
	    defineBuiltInFunction('PPMT', fi_ppmt, 4, 6, [doubleArgDefaultValue, doubleArgDefaultValue3, doubleArgDefaultValue,
	            doubleArgDefaultValue, doubleArgDefaultValue1, doubleArgDefaultValue1],
	        keyword_undefined, keyword_undefined, {_acceptsMissingArgument: [4, 5]});
	    defineBuiltInFunction('COUPDAYBS', fi_coupdaybsFunc, 3, 4, finArgsLimitDefaultValue,
	        keyword_undefined, keyword_undefined, {_acceptsMissingArgument: 3});
	    defineBuiltInFunction('COUPDAYS', fi_coupdaysFunc, 3, 4, finArgsLimitDefaultValue,
	        keyword_undefined, keyword_undefined, {_acceptsMissingArgument: 3});
	    defineBuiltInFunction('COUPDAYSNC', fi_coupdaysncFunc, 3, 4, finArgsLimitDefaultValue,
	        keyword_undefined, keyword_undefined, {_acceptsMissingArgument: 3});
	    defineBuiltInFunction('COUPNCD', fi_coupncdFunc, 3, 4, finArgsLimitDefaultValue,
	        keyword_undefined, keyword_undefined, {_acceptsMissingArgument: 3});
	    defineBuiltInFunction('COUPNUM', fi_coupnumFunc, 3, 4, finArgsLimitDefaultValue,
	        keyword_undefined, keyword_undefined, {_acceptsMissingArgument: 3});
	    defineBuiltInFunction('COUPPCD', fi_couppcdFunc, 3, 4, finArgsLimitDefaultValue,
	        keyword_undefined, keyword_undefined, {_acceptsMissingArgument: 3});
	    defineBuiltInFunction('DURATION', fi_durationFunc, 5, 6, finArgsLimitDefaultValue1,
	        keyword_undefined, keyword_undefined, {_acceptsMissingArgument: 5});
	    defineBuiltInFunction('MDURATION', fi_mduration, 5, 6, finArgsLimitDefaultValue1,
	        keyword_undefined, keyword_undefined, {_acceptsMissingArgument: 5});
	    defineBuiltInFunction('NPER', fi_nper, 3, 5, [{_argType: 0 , _argCondition: '<= -1'},
	            doubleArgDefaultValue, doubleArgDefaultValue, doubleArgDefaultValue1, doubleArgDefaultValue1],
	        keyword_undefined, keyword_undefined, {_acceptsMissingArgument: [3, 4]});
	    defineBuiltInFunction('YIELD', fi_yieldFunc, 6, 7,
	        [dateTimeArgDefaultValue, dateTimeArgDefaultValue, doubleArgDefaultValue4, doubleArgDefaultValue4,
	            doubleArgDefaultValue2, stringIntArgDefaultValue, stringIntArgDefaultValue4],
	        keyword_undefined, keyword_undefined, {_acceptsMissingArgument: 6});
	    defineBuiltInFunction('YIELDDISC', fi_yielddisc, 4, 5, [dateTimeArgDefaultValue, dateTimeArgDefaultValue,
	            doubleArgDefaultValue2, doubleArgDefaultValue2, stringIntArgDefaultValue4],
	        keyword_undefined, keyword_undefined, {_acceptsMissingArgument: 3});
	    defineBuiltInFunction('YIELDMAT', fi_yieldmat, 5, 6, [dateTimeArgDefaultValue, dateTimeArgDefaultValue,
	            dateTimeArgDefaultValue, doubleArgDefaultValue4, doubleArgDefaultValue, stringIntArgDefaultValue4],
	        keyword_undefined, keyword_undefined, {_acceptsMissingArgument: 5});
	    defineBuiltInFunction('AMORDEGRC', fi_amordegrc, 6, 7, finArgsLimitDefaultValue3,
	        keyword_undefined, keyword_undefined, {_acceptsMissingArgument: 6});
	    defineBuiltInFunction('AMORLINC', fi_amorlinc, 6, 7, finArgsLimitDefaultValue3,
	        keyword_undefined, keyword_undefined, {_acceptsMissingArgument: 6});
	    defineBuiltInFunction('ODDFYIELD', fi_oddfyield, 8, 9,
	        [dateTimeArgDefaultValue, dateTimeArgDefaultValue, dateTimeArgDefaultValue, dateTimeArgDefaultValue,
	            doubleArgDefaultValue4, doubleArgDefaultValue2, doubleArgDefaultValue2, stringIntArgDefaultValue, stringIntArgDefaultValue4],
	        keyword_undefined, keyword_undefined, {_acceptsMissingArgument: 8});
	    defineBuiltInFunction('ODDLYIELD', fi_oddlyield, 7, 8,
	        [dateTimeArgDefaultValue, dateTimeArgDefaultValue, dateTimeArgDefaultValue, doubleArgDefaultValue4,
	            doubleArgDefaultValue4, doubleArgDefaultValue2, doubleArgDefaultValue, stringIntArgDefaultValue4],
	        keyword_undefined, keyword_undefined, {_acceptsMissingArgument: 7});
	    defineBuiltInFunction('ODDLPRICE', fi_oddlprice, 7, 8,
	        [dateTimeArgDefaultValue, dateTimeArgDefaultValue, dateTimeArgDefaultValue, doubleArgDefaultValue4,
	            doubleArgDefaultValue4, doubleArgDefaultValue2, stringIntArgDefaultValue, stringIntArgDefaultValue4],
	        keyword_undefined, keyword_undefined, {_acceptsMissingArgument: 7});
	    ...
	    defineBuiltInFunction('IRR', fi_irr, 1, 2, [arrayArgDefaultValue, doubleArgDefaultValue5],
	        0, 0, {_acceptsMissingArgument: 1});
	    defineBuiltInFunction('MIRR', fi_mirr, 3, 3, [arrayArgDefaultValue, doubleArgDefaultValue, doubleArgDefaultValue], 0, 0);
	    defineBuiltInFunction('XIRR', fi_xirr, 2, 3, [arrayArgDefaultValue1, {
	            _argType: 4 ,
	            _valueType: 4 ,
	            _toOneDimension: true,
	            _breakOnError: true,
	            breakOnConvertError: true
	        }, doubleArgDefaultValue5],
	        '!= 2', '!= 2', {_acceptsMissingArgument: 2});
	    defineBuiltInFunction('RATE', fi_rate, 3, 6,
	        [doubleArgDefaultValue2, doubleArgDefaultValue, doubleArgDefaultValue, doubleArgDefaultValue1, {
	            _defaultValue: 0,
	            _argType: 2 ,
	            _argCondition: '< 0',
	    ...
	    defineBuiltInFunction('VDB', fi_vdb, 5, 7, [doubleArgDefaultValue4, doubleArgDefaultValue4, stringIntArgDefaultValue7,
	            doubleArgDefaultValue4, doubleArgDefaultValue4, doubleArgDefaultValue6, boolArgDefaultValue],
	        keyword_undefined, keyword_undefined, {_acceptsMissingArgument: [5, 6]});
	    defineBuiltInFunction('ACCRINT', fi_accrint, 6, 8, [dateTimeArgDefaultValue, dateTimeArgDefaultValue, dateTimeArgDefaultValue,
	            doubleArgDefaultValue2, doubleArgDefaultValue8, stringIntArgDefaultValue, stringIntArgDefaultValue4],
	        keyword_undefined, keyword_undefined, {_acceptsMissingArgument: [4, 6, 7]});
	    defineBuiltInFunction('ACCRINTM', fi_accrintm, 3, 5, [dateTimeArgDefaultValue, dateTimeArgDefaultValue,
	            doubleArgDefaultValue2, doubleArgDefaultValue8, stringIntArgDefaultValue4],
	        keyword_undefined, keyword_undefined, {_acceptsMissingArgument: [3, 4]});
	    ...
	    defineBuiltInFunction('INTRATE', fi_intrate, 4, 5, finArgsLimitDefaultValue5, keyword_undefined, keyword_undefined,
	        {_acceptsMissingArgument: 3});
	    ...
	    defineBuiltInFunction('DB', fi_db, 4, 5, [doubleArgDefaultValue4, doubleArgDefaultValue, stringIntArgDefaultValue2,
	            stringIntArgDefaultValue2, {_defaultValue: 12, _argType: 2 , _argCondition: ['< 1', '> 12']}],
	        keyword_undefined, keyword_undefined, {_acceptsMissingArgument: 3});
	    defineBuiltInFunction('DDB', fi_ddb, 4, 5, [doubleArgDefaultValue4, doubleArgDefaultValue, stringIntArgDefaultValue1,
	            stringIntArgDefaultValue1, {_defaultValue: 2, _argType: 0 , _argCondition: '<= 0'}],
	        keyword_undefined, keyword_undefined, {_acceptsMissingArgument: 3});
	    ...
	    defineBuiltInFunction('PRICE', fi_price, 6, 7,
	        [dateTimeArgDefaultValue, dateTimeArgDefaultValue, doubleArgDefaultValue4, doubleArgDefaultValue4,
	            doubleArgDefaultValue7, stringIntArgDefaultValue, stringIntArgDefaultValue4],
	        keyword_undefined, keyword_undefined, {_acceptsMissingArgument: 6});
	    defineBuiltInFunction('PRICEDISC', fi_pricedisc, 4, 5, finArgsLimitDefaultValue5, keyword_undefined, keyword_undefined,
	        {_acceptsMissingArgument: 3});
	    defineBuiltInFunction('PRICEMAT', fi_pricemat, 5, 6, [dateTimeArgDefaultValue, dateTimeArgDefaultValue,
	            dateTimeArgDefaultValue, doubleArgDefaultValue4, doubleArgDefaultValue4, stringIntArgDefaultValue4],
	        keyword_undefined, keyword_undefined, {_acceptsMissingArgument: 5});
	    defineBuiltInFunction('ODDFPRICE', fi_oddfprice, 8, 9,
	        [dateTimeArgDefaultValue, dateTimeArgDefaultValue, dateTimeArgDefaultValue, dateTimeArgDefaultValue,
	    ...
	    defineBuiltInFunction('EUROCONVERT', fi_euroconvert, 3, 5,
	        [doubleArgDefaultValue, stringArgDefaultValue, stringArgDefaultValue, boolArgDefaultValue,
	            {
	                _needArgExistsValue: true,
	                _argType: 2 ,
	                _defaultValue: 3,
...
/***/ (function(module, exports, __webpack_require__) {
	...
	(function () {
	    ...
	    var keyword_null = null, keyword_undefined = void 0;
	    var RegexHelper = Common._RegexHelper, Types = Common._Types,
	        parseInvariant = Common._DateTimeHelper._parseInvariant,
	        Types_extend = Types._extend, isNullOrUndefined = Types._isNullOrUndefined, inherit = Types._inherit,
	        arrayHelper_getLength = Common._ArrayHelper._getLength;
	    var CalcConvert = Calc.Convert, CalcConvert_isError = CalcConvert._isError,
	        CalcConvert_toInt = CalcConvert._toInt, CalcConvert_tryToInt = CalcConvert._tryToInt,
	        CalcConvert_isNumber = CalcConvert._isNumber, CalcConvert_toDouble = CalcConvert._toDouble,
	        CalcConvert_toString = CalcConvert._toString;
	    var CalcErrors = Calc.Errors, CalcErrorsValue = CalcErrors.Value, CalcErrorsReference = CalcErrors.Reference,
	        CalcErrorsNotAvailable = CalcErrors.NotAvailable, CalcErrorsNull = CalcErrors.Null;
	    var CalcParser = Calc.Parser, CalcReference = Calc.CalcReference, CalcArrayHelper = Calc.CalcArrayHelper;
	    var Functions = Calc.Functions, defineBuiltInFunction = Functions._defineBuiltInFunction,
	        isBoolean = Functions._isBoolean, isString = Functions._isString;
	    ...
	    var createRange = function (r, c, rc, cc) {
	        return {
	            row: r,
	            col: c,
	            rowCount: rc,
	    ...
	    function findCompareTypeValid(find, val) {
	    ...
	    function compareValue(a, b, case_sensitive) {
	        ...
	        if (isString(a)) {
	            if (!b && arrayHelper_getLength(a.toString()) === 0) {
	                ...
	                var t = case_sensitive ? a.toString().localeCompare(b.toString()) : a.toLowerCase().localeCompare(b.toLowerCase());
	                if (t === 0) {
	                    return 0;
	                } else if (t > 0) {
	                    return 1;
	    ...
	    function findIndexBisection(find, data, type, height) {
	        ...
	        while (low <= high) {
	            var v = keyword_null, start, realVal = find[0];
	            if ((type >= 1) !== (comp === 2)) {
	                prev = mid;
	            }
	    ...
	    function findIndexLinear(find, data, type, height) {
	        ...
	        for (lp = 0; lp < length; lp++) {
	            v = height ? getValueAreaXY(data, 0, lp) : getValueAreaXY(data, lp, 0);
	            if (!findCompareTypeValid(realVal, v)) {
	                continue;
	            }
	    ...
	    var CellInfoReference = (function (_super) {
	        inherit(CellInfoReference, _super);
	        function CellInfoReference(source, row, column, rowCount, columnCount, type) {
	            var self = this;
	            _super.call(self, source, [createRange(row, column, rowCount, columnCount)]);
	            self._row = row;
	            self._column = column;
	        ...
	        var prototype = {
	            ...
	            getValue: function (area, rowOffset, columnOffset) {
	                ...
	                if (type === 0 ) {
	                    ...
	                    ret = _super.prototype.getValue.call(self, area, rowOffset, columnOffset);
	                }
	                return ret;
	            },
	            toArray: function (valueType, toOneDimension) {
	                var self = this, result = [], baseRow = self._row, baseCol = self._column, type = self._type,
	                    rangeCount = self.getRangeCount(), rowCount = self._rowCount, colCount = self._columnCount,
	                    range, value, rangeArr, rowArr, r, c;
	                    ...
	                    for (r = 0; r < rowCount; r++) {
	                        ...
	                        for (c = 0; c < colCount; c++) {
	                            if (type === 0 ) {
	                                ...
	                                value = _super.prototype.getValue.call(self, range, baseRow + r, baseCol + c);
	                            }
	        ...
	        Types_extend(CellInfoReference.prototype, prototype);
	
	        return CellInfoReference;
	    })(Calc.CalcReference);
	    var TransposedArray = (function (_super) {
	        inherit(TransposedArray, _super);
	        ...
	        var prototype = {
	            getRowCount: function () {
	                return CalcArrayHelper.getColumnCount(this._array);
	            },
	            getColumnCount: function () {
	                return CalcArrayHelper.getRowCount(this._array);
	            },
	            getValue: function (row, column) {
	                return CalcArrayHelper.getValue(this._array, column, row);
	            }
	        };
	        Types_extend(TransposedArray.prototype, prototype);
	    ...
	    function eg_rowColumn(context, reference, isRow) {
	        ...
	        var isArrayFormula = context.arrayFormulaMode, hasReference = reference !== keyword_undefined,
	            type = isRow ? 0  : 1 ;
	        reference = hasReference ? reference : context.getReference(context.source, Calc._createRangeIdentity(context.row, context.column, context.rowCount, context.columnCount));
	        if (!reference || reference.getRangeCount() !== 1) {
	            return CalcErrorsValue;
	        }
	        if (isArrayFormula && hasReference) {
	            return new CellInfoReference(reference.getSource(), reference.getRow(0), reference.getColumn(0), reference.getRowCount(0), 1, type);
	        }
	        return (isRow ? reference.getRow(0) : reference.getColumn(0)) + 1;
	    }
	
	    function eg_hlookupVlookup(lookVal, array, rowColIndex, approx, isVlookup) {
	        if (isVlookup && rowColIndex > array.colCount || !isVlookup && rowColIndex > array.rowCount) {
	            return CalcErrorsReference;
	        }
	        var index = approx ? findIndexBisection(lookVal, array, 1, isVlookup) : findIndexLinear(lookVal, array, 0, isVlookup);
	        if (index >= 0) {
	            return isVlookup ? fetchValueAreaXY(array, rowColIndex - 1, index) : fetchValueAreaXY(array, index, rowColIndex - 1);
	        }
	        return CalcErrorsNotAvailable;
	    }
	    ...
	    function eg_rows(array) {
	        return CalcArrayHelper.getRowCount(array);
	    }
	
	    function eg_columns(array) {
	        return CalcArrayHelper.getColumnCount(array);
	    }
	    ...
	    function eg_hlookup(lookupValue, array, rowColIndex, approx) {
	        return eg_hlookupVlookup(lookupValue, array, rowColIndex, approx, false);
	    }
	
	    function eg_vlookup(lookupValue, array, rowColIndex, approx) {
	        return eg_hlookupVlookup(lookupValue, array, rowColIndex, approx, true);
	    }
	    ...
	    function eg_lookup(lookupValue, lookupVector, resultVector) {
	        ...
	        if (lookupVector) {
	            for (var i = 0; i < lookupVector.length; i++) {
	                if (!isNullOrUndefined(lookupVector[i])) {
	        ...
	        if (resultVector !== keyword_undefined) {
	            result = CalcConvert._toArray(resultVector, 0 , true, false, false);
	        } else {
	            var val = width > height ? eg_hlookup(lookVal, array, height, true) : eg_vlookup(lookVal, array, width, true);
	    ...
	    function eg_match(lookupValue, lookupArray, matchType) {
	        function assertOrder(v, ascending) {
	            if (!ascending) {
	                var length = arrayHelper_getLength(v), i;
	                for (i = 1; i < length; i++) {
	        ...
	        if (matchType === 1 && !assertOrder(array, true) || matchType === -1 && !assertOrder(array, false)) { 
	            return CalcErrorsNotAvailable;
	        }
	        if (matchType === 1) {
	    ...
	    function appendA1Letter(addr, coord, relative) {
	        ...
	        for (; coord > 0.1; coord = parseInt((coord - 1) / 26), 10) {
	            addr = Common._StringHelper._insert(addr, position, String.fromCharCode('A'.charCodeAt(0) + (coord - 1) % 26));
	        }
	        return addr;
	    }
	    function appendExternalName(addr, name) {
	        if (name && 0 < arrayHelper_getLength(name)) {
	            var i, needQuotes = !Calc._isLetter(name[0]) && name[0] !== '_';
	            for (i = 1; !needQuotes && i < arrayHelper_getLength(name); i++) {
	                needQuotes = !Calc._isLetterOrDigit(name[i]) && name[i] !== '_';
	            }
	            if (needQuotes) {
	                addr += '\'';
	                addr += name.replace('\'', '\'\'');
	    ...
	    function eg_address(row, col, absNum, a1, sheetText) {
	        ...
	        var addr = '';
	        if (row < 1 && (a1 || !rowRelative) || row > Calc.maxRowCount ||
	            col < 1 && (a1 || !colRelative) || col > Calc.maxColumnCount || absNum < 1 || 8 < absNum) {
	            return CalcErrorsValue;
	        }
	    ...
	    function eg_index(context, range, row, column, area) {
	        ...
	        if (range instanceof CalcReference) {
	            var intValue = {value: -1}, reference = range;
	            var arrayRowCount = reference.getRowCount(0), arrayColumnCount = reference.getColumnCount(0);
	            var arrayRow = reference.getRow(0), arrayCol = reference.getColumn(0);
	            ...
	            if (arrayHelper_getLength(arguments) === 3) {
	                ...
	                var index = argumentValid(row) && CalcConvert_tryToInt(row, intValue) ? intValue.value : 0;
	                ...
	                if (index === 0) {
	                    return reference.create([createRange(arrayRow, arrayCol, arrayRowCount, arrayColumnCount)]);
	                }
	                offsetRow = Math.floor((index - 1) / arrayColumnCount) + arrayRow;
	                offsetCol = (index - 1) % arrayColumnCount + arrayCol;
	                return reference.create([createRange(offsetRow, offsetCol, 1, 1)]);
	            }
	            row = argumentValid(row) && CalcConvert_tryToInt(row, intValue) ? intValue.value - 1 : -1;
	            column = argumentValid(column) && CalcConvert_tryToInt(column, intValue) ? intValue.value - 1 : -1;
	            area = argumentValid(area) && CalcConvert_tryToInt(area, intValue) ? intValue.value - 1 : 0;
	            if (area >= reference.getRangeCount()) {
	                return CalcErrorsReference;
	            }
	            arrayRowCount = reference.getRowCount(area);
	            arrayColumnCount = reference.getColumnCount(area);
	            var sourceRow = reference.getRow(area), sourceCol = reference.getColumn(area);
	            ...
	            offsetRow = row + sourceRow;
	            offsetCol = column + sourceCol;
	            ...
	            if (row === -1 && column === -1) {
	                return reference.create([createRange(sourceRow, sourceCol, arrayRowCount, arrayColumnCount)]);
	            } else if (row === -1) {
	                return reference.create([createRange(sourceRow, offsetCol, arrayRowCount, 1)]);
	            } else if (column === -1) {
	                return reference.create([createRange(offsetRow, sourceCol, 1, arrayColumnCount)]);
	            }
	            return reference.create([createRange(offsetRow, offsetCol, 1, 1)]);
	        } else if (CalcConvert._isArray(range)) {
	            var array = range;
	    ...
	    function eg_offset(reference, rows, columns, height, width) {
	        if (!reference || !(reference instanceof CalcReference) || reference.getRangeCount() !== 1) {
	            return CalcErrorsValue;
	        }
	        ...
	        return reference.create([{row: offsetRow, col: offsetColumn, rowCount: height, colCount: width}]);
	    }
	    ...
	    function eg_indirect(context, reference, useA1) {
	        ...
	        var baseRow = context.row, baseCol = context.column,
	            baseIdentity = Calc._createCellIdentity(baseRow, baseCol);
	        ...
	        if (!parser) {
	            parser = context.parser = new CalcParser();
	        }
	
	        var parserContext = context.source.parserContext;
	        if (!parserContext) {
	            context.source.parserContext = parserContext = context.source ? context.source.getParserContext(!useA1, baseIdentity) : new Calc.ParserContext(context.source, !useA1, baseIdentity);
	        ...
	        if (useA1) {
	            ...
	            if (!context.source.expressions) {
	                context.source.expressions = {};
	            }
	            expression = context.source.expressions[reference];
	            if (!expression) {
	                expression = parser.parse(parserContext, reference);
	                context.source.expressions[reference] = expression;
	            }
	        }
	        ...
	        if (expression) {
	            ...
	            return range.rowCount === 1 && range.colCount === 1 && !context.acceptsReference && !context.arrayFormulaMode ?
	                source.getValue(range.row, range.col) : source.getReference(range);
	        }
	        return CalcErrorsReference;
	    }
	    ...
	    function eg_hyperlink(link_location, friendly_name) {
	        if (arguments.length === 2) {
	            return CalcConvert_toString(friendly_name);
	        }
	        return CalcConvert_toString(link_location);
	    }
	    ...
	    function eg_formulatext(context, reference) {
	        ...
	        var formula = context.source.getCalcSourceModel().getFormula(row, col);
	        if (formula) {
	            return "=" + formula;
	        }
	        return CalcErrorsNotAvailable;
	    ...
	    var boolArgDefaultValue = {_defaultValue: true, _argType: 7 },
	        stringIntArgDefaultValue = {_argType: 2 },
	        stringIntArgDefaultValueNone = {_defaultValue: NaN, _argType: 2 },
	        stringIntArgDefaultValue1 = {_defaultValue: 1, _argType: 2 },
	        stringIntArgDefaultValue2 = {
	            _argType: 2 ,
	            _argCondition: '<= 0',
	            _conditionErrorValue: CalcErrorsValue
	        },
	    ...
	    defineBuiltInFunction('ADDRESS', eg_address, 2, 5, [stringIntArgDefaultValue, stringIntArgDefaultValue,
	            stringIntArgDefaultValue1, boolArgDefaultValue, {_defaultValue: '', _argType: 5 }],
	        keyword_undefined, keyword_undefined, {_acceptsMissingArgument: [2, 3, 4]});
	    ...
	    defineBuiltInFunction('ROW', eg_row, 0, 1, keyword_undefined, -1, keyword_undefined,
	        {_isContextSensitive: true, _precedentReference: -1, expandColumns: -1});
	    defineBuiltInFunction('COLUMN', eg_column, 0, 1, keyword_undefined, -1, keyword_undefined,
	        {_acceptsMissingArgument: 0, _isContextSensitive: true, _precedentReference: -1, expandRows: -1});
	    defineBuiltInFunction('ROWS', eg_rows, 1, 1, keyword_undefined, -1, -1,
	        {_precedentReference: -1, expandColumns: -1, _isVolatile: true});
	    defineBuiltInFunction('COLUMNS', eg_columns, 1, 1, keyword_undefined, -1, -1,
	        {_precedentReference: -1, expandRows: -1, _isVolatile: true});
	    ...
	    defineBuiltInFunction('HLOOKUP', eg_hlookup, 3, 4, [arrayArgDefaultValue, arrayArgDefaultValue,
	        stringIntArgDefaultValue2, boolArgDefaultValue], 1, 1, {_acceptsMissingArgument: 3});
	    defineBuiltInFunction('VLOOKUP', eg_vlookup, 3, 4, [arrayArgDefaultValue, arrayArgDefaultValue,
	        stringIntArgDefaultValue2, boolArgDefaultValue], 1, 1, {_acceptsMissingArgument: 3});
	    ...
	    defineBuiltInFunction('MATCH', eg_match, 2, 3, [arrayArgDefaultValue, arrayArgDefaultValue,
	        stringIntArgDefaultValueNone], 1, 1, {_acceptsMissingArgument: 2});
	    defineBuiltInFunction('INDIRECT', eg_indirect, 1, 2, [{_argType: 5 }, boolArgDefaultValue],
...
/***/ (function(module, exports, __webpack_require__) {
	...
	(function () {
	    ...
	    var Math_pow = Math.pow, Math_max = Math.max, Math_min = Math.min, Math_floor = Math.floor,
	        Math_sin = Math.sin, Math_tan = Math.tan, Math_PI = Math.PI, Math_atan = Math.atan, Math_exp = Math.exp,
	        Math_abs = Math.abs, Math_sqrt = Math.sqrt, Math_log = Math.log, Math_round = Math.round;
	    var CalcErrors = Calc.Errors, CalcErrorsDivideByZero = CalcErrors.DivideByZero, CalcErrorsValue = CalcErrors.Value,
	        CalcErrorsNotAvailable = CalcErrors.NotAvailable, CalcErrorsNumber = CalcErrors.Number, CalcErrorsNull = CalcErrors.Null;
	    var CalcArray = Calc.CalcArray;
	    var CalcConvert = Calc.Convert, CalcConvert_toResult = CalcConvert._toResult, CalcConvert_toArray = CalcConvert._toArray,
	        CalcConvert_toInt = CalcConvert._toInt, CalcConvert_toDouble = CalcConvert._toDouble;
	    var MathHelper = Functions._MathHelper, combin = MathHelper._combin, parseCriteria = MathHelper._parseCriteria;
	    var CalcConvert_isNumber = CalcConvert._isNumber, CalcConvert_isError = CalcConvert._isError;
	    var st_includeSubstotals = Functions._st_includeSubstotals, st_devVarIncludeSubtotals = Functions._st_devVarIncludeSubtotals, st_includeAggregateMulti = Functions._st_includeAggregateMulti,
	        st_normsdist = Functions._st_normsdist, isBoolean = Functions._isBoolean,
	        isString = Functions._isString, Functions_isNumber = Functions._isNumber, MAX_DOUBLE_VALUE = Functions._MAX_DOUBLE_VALUE;
	    var CalcConvertedError = CalcConvert.CalcConvertedError;
	    var defineBuiltInFunction = Functions._defineBuiltInFunction;
	    var _tryToDouble = CalcConvert._tryToDouble, _tryToInt = CalcConvert._tryToInt;
	    ...
	    function _betacf(a, b, x) {
	        var m, m2;
	        var retval, aa, c, d, del, qab, qam, qap;
	        var ITMAX = 300;
	        var FPMIN = 1.0E-50;
	        var EPSILON = 1.0E-20;
	        qab = a + b;
	    ...
	    function _lgammacor(x) {
	        ...
	        var nalgm = _chebyshev_init(algmcs, 15, _d1mach(3)),
	            xbig = 1.0 / Math_sqrt(_d1mach(3)),
	            xmax = Math_exp(Math_min(Math_log(_d1mach(2) / 12.0), -Math_log(12.0 * _d1mach(1))));
	        if (x < 10.0) {
	            return NaN;
	        } else if (x >= xmax) {
	    ...
	    function _pbeta_raw(x, pin, qin) {
	        var ans, c, finsum, ps, p1, term, xb, xi;
	        var n, i, ib;
	        var eps, alneps, sml, alnsml;
	        eps = _d1mach(3);
	        alneps = Math_log(eps);
	        sml = _d1mach(1);
	        alnsml = Math_log(sml);
	        ...
	        if ((p + q) * y / (p + 1.0) < eps) {
	            ...
	            if (q > 1.0) {
	                ...
	                ib = CalcConvert_toInt(Math_max(xb / alnsml, 0.0));
	    ...
	    function _stat1(closure, array) {
	        var length = arrayHelper_getLength(array), i;
	        for (i = 0; i < length; i++) {
	            var x = CalcConvert_toDouble(array[i]),
	                dx = x - closure.M,
	                dm = dx / (closure.N + 1);
	            closure.M += dm;
	    ...
	    function getBetaHelperContFrac(fX, fA, fB) {
	        var a1, b1, a2, b2, fnorm, apl2m, d2m, d2m1, cfnew, cf;
	        ...
	        for (i = 0; i < arrayHelper_getLength(args); i++) {
	            ...
	            for (j = 0; j < arrayHelper_getLength(array); j++) {
	                ...
	                if (obj === keyword_null) {
	                    ...
	                    var nValue = {value: 0};
	                    if (CalcConvert._tryToDouble(obj, nValue)) {
	                        x = nValue.value;
	                        stc._sumx += x;
	                        stc._sumx2 += x * x;
	    ...
	    function st_stdev_var(args, compareNum, needSqrt) {
	        var data = {_sumx: 0.0, _sumx2: 0.0, n: 0.0};
	        var flag = _dev2(args, data);
	    ...
	    function st_linest_logest(isLogest, knownY, knownX, constant, stats) {
	        ...
	        if (knownY_rowCount === knownX_rowCount && knownY_colCount === knownX_colCount && (constant || !stats)) {
	            ...
	            var sumx = 0.0, sumx2 = 0.0, sumy = 0.0, sumy2 = 0.0, sumxy = 0.0, b;
	    ...
	    function st_trend(knownY, knownX, newX, constant) {
	        ...
	        return Common._trend(knownY, knownX, newX, constant, CalcConvert_toDouble, CalcArray, CalcErrorsValue, CalcErrorsNotAvailable);
	    }
	    ...
	    function st_growth(knownY, knownX, newX, constant) {
	        ...
	        return Common._growth(knownY, knownX, newX, constant, CalcArray, CalcErrorsNumber, CalcErrorsNotAvailable);
	    }
	    ...
	    function st_average() {
	        return st_includeSubstotals(arguments, true, 1 );
	    }
	
	    function st_stdev() {
	        return st_devVarIncludeSubtotals(arguments, true, 7 );
	    }
	    ...
	    function st_max() {
	        return st_includeSubstotals(arguments, true, 4 );
	    }
	    ...
	    function st_min() {
	        return st_includeSubstotals(arguments, true, 5 );
	    }
	    ...
	    function st_averagea() {
	        ...
	        for (i = 0; i < arrayHelper_getLength(args); i++) {
	            ...
	            for (j = 0; j < arrayHelper_getLength(array); j++) {
	                obj = array[j];
	                if (CalcConvert_isNumber(obj) || isBoolean(obj)) {
	    ...
	    function _averageifImp(range, criteria, sumRange) {
	        var sum = 0.0, n = 0.0;
	    ...
	    function getAverageResult(isArray, critieriaData, range, sumRange) {
	        var rowCount = isArray ? critieriaData.rowCount : critieriaData.getRowCount(0);
	        var colCount = isArray ? critieriaData.colCount : critieriaData.getColumnCount(0);
	        var result = [], r, c;
	        for (r = 0; r < rowCount; r++) {
	            result[r] = [];
	            for (c = 0; c < colCount; c++) {
	                var temp = isArray ? critieriaData.getValue(r, c) : critieriaData.getValue(0, r, c);
	                result[r][c] = _averageifImp(range, temp, sumRange);
	            }
	        }
	        return new CalcArray(result);
	    }
	
	    function st_averageif(range, critieriaData, sumRange) {
	        if (sumRange !== keyword_undefined) {
	            range = CalcConvert_toArray(range, 0 , true, false, false);
	           
	            sumRange = CalcConvert_toArray(sumRange, 1 , true, true, false, true, keyword_undefined, true);
	            if (sumRange.isError) {
	                return sumRange[0];
	            }
	        } else {
	            range = CalcConvert_toArray(range, 1 , true, true, false);
	            if (range.isError) {
	                return range[0];
	            }
	            sumRange = range;
	        }
	        if (CalcConvert._isReference(critieriaData)) {
	            return getAverageResult(false, critieriaData, range, sumRange);
	        }
	        if (CalcConvert._isArray(critieriaData)) {
	            return getAverageResult(true, critieriaData, range, sumRange);
	        }
	        return _averageifImp(range, critieriaData, sumRange);
	    }
	
	    function st_averageifs(sumRange) {
	        var args = arguments;
	        var sum = 0.0, n = 0.0, num, i, argIndex;
	        var length = sumRange.length, argLength = args.length;
	        var array;
	        var processedArgs = [];
	        processedArgs.push(sumRange);
	        for (argIndex = 1; argIndex < argLength; argIndex = argIndex + 2) {
	            array = CalcConvert_toArray(args[argIndex], 0 , true, false, false);
	            if (array.isError) {
	                return array[0];
	            }
	            processedArgs.push(array);
	            var criteria = args[argIndex + 1];
	            var crit = parseCriteria(criteria);
	            processedArgs.push(crit);
	        }
	        for (i = 0; i < length; i++) {
	            num = sumRange[i];
	            if (num !== CalcConvertedError) {
	                var condition = true;
	                for (argIndex = 1; argIndex < argLength; argIndex = argIndex + 2) {
	                    crit = processedArgs[argIndex + 1];
	                    condition = crit(processedArgs[argIndex][i]);
	                    if (!condition) {
	                        break;
	                    }
	                }
	    ...
	    function st_frequency(dataArray, binsArray) {
	        ...
	        return new CalcArray(results);
	    }
	
	    function st_rank(num, array, order) {
	        var arrayHelper = Calc.CalcArrayHelper;
	        if (CalcConvert._isReference(num)) {
	    ...
	    function st_count() {
	        return st_includeSubstotals(arguments, true, 2 );
	    }
	
	    function st_counta() {
	        return st_includeSubstotals(arguments, true, 3 );
	    }
	    ...
	    function st_countif(range, criteria) {
	        var count = 0.0, d, val, i;
	        if (criteria.isArray || criteria.isReference) {
	            for (i = 0; i < arrayHelper_getLength(criteria); i++) {
	    ...
	    function st_countifs(conditionArray) {
	        var args = arguments;
	        var count = 0.0, array, i, argIndex, crit;
	        var length = arrayHelper_getLength(conditionArray), argLength = arrayHelper_getLength(args);
	        var processedArgs = [];
	        for (argIndex = 0; argIndex < argLength; argIndex = argIndex + 2) {
	            array = argIndex === 0 ? conditionArray : CalcConvert_toArray(args[argIndex], 0 , true, false, false);
	            if (array.isError) {
	                return array[0];
	            }
	            length = array.length;
	            processedArgs.push(array);
	            crit = parseCriteria(args[argIndex + 1]);
	            processedArgs.push(crit);
	        }
	        for (i = 0; i < length; i++) {
	            var condition = true;
	            for (argIndex = 0; argIndex < argLength; argIndex = argIndex + 2) {
	                crit = processedArgs[argIndex + 1];
	                condition = (crit && crit(processedArgs[argIndex][i]));
	                if (!condition) {
	                    break;
	                }
	            }
	    ...
	    function st_stdeva() {
	        return st_stdev_var(arguments, 1, true);
	    }
	
	    function st_stdevp() {
	        return st_devVarIncludeSubtotals(arguments, true, 8 );
	    }
	
	    function st_stdevpa() {
	        return st_stdev_var(arguments, 0, true);
	    }
	
	    function st_varr() {
	        return st_devVarIncludeSubtotals(arguments, true, 10 );
	    }
	
	    function st_vara() {
	        return st_stdev_var(arguments, 1, false);
	    }
	
	    function st_varp() {
	        return st_devVarIncludeSubtotals(arguments, true, 11 );
	    }
	
	    function st_varpa() {
	        return st_stdev_var(arguments, 0, false);
	    }
	    ...
	    function st_correl(arrayX, arrayY) {
	    ...
	    function st_poisson(x, mean, cumulative) {
	        ...
	        if (cumulative) {
	            for (var i = 0; i <= x; i++) {
	                result += (Math_exp(-mean) * Math_pow(mean, i)) / Functions._fact(i);
	            }
	        } else {
	            result = (Math_exp(-mean) * Math_pow(mean, x)) / Functions._fact(x);
	        }
	        return CalcConvert_toResult(result);
	    }
	    ...
	    function st_modemult() {
	        ...
	        return modeCount === 0 ? CalcErrorsNotAvailable : new CalcArray(modes);
	    }
	    ...
	    function st_permutationa(number, number_chosen) {
	        ...
	        if (number >= 0 && number < 2147483647 && chosen >= 0 && chosen < 2147483647) {
	            number = Math.pow(parseInt(number), parseInt(chosen));
	            var numberAbs = Math.abs(number);
	            if (numberAbs <= 1.79769e+308) {
	                return numberAbs >= 2.2250738585072014E-308 ? number : 0.0;
	            }
	    ...
	    function st_gamma(number) {
	        if (number > 0.0) {
	            ...
	            var integralNumber = Math.abs(parseInt(number));
	    ...
	    var boolArgDefaultValue = {_argType: 7 },
	        boolArgDefaultValue1 = {_defaultValue: true, _argType: 7 };
	    var stringIntArgDefaultValue = {_argType: 2 },
	        stringIntArgDefaultValue1 = {_argType: 2 , _argCondition: '< 1'},
	        stringIntArgDefaultValue2 = {_argType: 2 , _argCondition: '< 0'},
	        stringIntArgDefaultValue4 = {_argType: 2 , _argCondition: ['< 1', '> 10000000000']};
	    var doubleArgDefaultValue = {_argType: 0 },
	        doubleArgDefaultValue1 = {_argType: 0 , _argCondition: ['< 0', '>= 1']},
	        doubleArgDefaultValue2 = {_argType: 0 , _argCondition: ['<= 0', '>= 1']},
	        doubleArgDefaultValue3 = {_argType: 0 , _argCondition: '<= 0'},
	        doubleArgDefaultValue4 = {_defaultValue: 0, _argType: 0 },
	        doubleArgDefaultValue5 = {_defaultValue: 1, _argType: 0 },
	        doubleArgDefaultValue6 = {_argType: 0 , _argCondition: ['< 0', '> 1']},
	        doubleArgDefaultValue7 = {_argType: 0 , _argCondition: '< 0'},
	        doubleArgDefaultValue8 = {_argType: 0 , _argCondition: ['< 1', '> 10000000000']},
	        doubleArgDefaultValue9 = {_argType: 0 , _argCondition: ['< 1', '>= 10000000000']};
	    var arrayArgDefaultValue = {
	            _argType: 4,
	            _valueType: 1 ,
	            _toOneDimension: true,
	        ...
	        arrayArgDefaultValue4 = {_argType: 4, _valueType: 1 , _breakOnError: true, _ignoreBlank: true},
	        arrayArgDefaultValue5 = {_argType: 4, _valueType: 0 , _toOneDimension: true},
	        arrayArgDefaultValue6 = {_argType: 4, _valueType: 1 , _toOneDimension: true},
	        arrayArgDefaultValue7 = {
	            _argType: 4,
	            _valueType: 1 ,
	            _toOneDimension: true,
	            _breakOnError: true,
	        ...
	        arrayArgDefaultValue10 = {_argType: 4, _valueType: 0 , _toOneDimension: true, _breakOnError: true},
	    ...
	    var statArgsLimitDefaultValue = [arrayArgDefaultValue, {_argType: 2 }],
	        statArgsLimitDefaultValue1 = [arrayArgDefaultValue1, stringIntArgDefaultValue],
	        statArgsLimitDefaultValue2 = [arrayArgDefaultValue, doubleArgDefaultValue,
	            {_defaultValue: 3, _argType: 2 , _argCondition: '< 1'}],
	        statArgsLimitDefaultValue3 = [doubleArgDefaultValue2, doubleArgDefaultValue3, stringIntArgDefaultValue1],
	        statArgsLimitDefaultValue4 = [doubleArgDefaultValue2, doubleArgDefaultValue3, doubleArgDefaultValue3,
	            doubleArgDefaultValue4, doubleArgDefaultValue5],
	        statArgsLimitDefaultValue5 = [stringIntArgDefaultValue2, stringIntArgDefaultValue2, doubleArgDefaultValue6, boolArgDefaultValue],
	        statArgsLimitDefaultValue6 = [stringIntArgDefaultValue2, doubleArgDefaultValue6, doubleArgDefaultValue2],
	        statArgsLimitDefaultValue7 = [doubleArgDefaultValue7, doubleArgDefaultValue8],
	        statArgsLimitDefaultValue8 = [doubleArgDefaultValue6, stringIntArgDefaultValue4],
	        statArgsLimitDefaultValue9 = [arrayArgDefaultValue1, arrayArgDefaultValue1],
	        statArgsLimitDefaultValue10 = [doubleArgDefaultValue7, doubleArgDefaultValue3, boolArgDefaultValue],
	        statArgsLimitDefaultValue11 = [doubleArgDefaultValue7, doubleArgDefaultValue9, doubleArgDefaultValue9],
	        statArgsLimitDefaultValue12 = [doubleArgDefaultValue6, doubleArgDefaultValue9, doubleArgDefaultValue9],
	        statArgsLimitDefaultValue13 = [arrayArgDefaultValue, arrayArgDefaultValue],
	        statArgsLimitDefaultValue14 = [doubleArgDefaultValue7, doubleArgDefaultValue3, doubleArgDefaultValue3, boolArgDefaultValue],
	        statArgsLimitDefaultValue15 = [doubleArgDefaultValue6, doubleArgDefaultValue3, doubleArgDefaultValue3],
	        statArgsLimitDefaultValue16 = [doubleArgDefaultValue6, doubleArgDefaultValue, doubleArgDefaultValue3],
	        statArgsLimitDefaultValue17 = [doubleArgDefaultValue, doubleArgDefaultValue, doubleArgDefaultValue3, boolArgDefaultValue],
	        statArgsLimitDefaultValue18 = [arrayArgDefaultValue6, arrayArgDefaultValue6],
	        statArgsLimitDefaultValue19 = [stringIntArgDefaultValue2, doubleArgDefaultValue7, boolArgDefaultValue],
	        statArgsLimitDefaultValue20 = [doubleArgDefaultValue7, stringIntArgDefaultValue1],
	        statArgsLimitDefaultValue21 = [arrayArgDefaultValue7, arrayArgDefaultValue7, stringIntArgDefaultValue,
	            {_argType: 2 , _argCondition: ['< 1', '> 3']}],
	        statArgsLimitDefaultValue22 = [doubleArgDefaultValue7, doubleArgDefaultValue3, doubleArgDefaultValue3, boolArgDefaultValue],
	        statArgsLimitDefaultValue23 = [arrayArgDefaultValue, doubleArgDefaultValue],
	        statArgsLimitDefaultValue24 = [arrayArgDefaultValue11, {},
	            boolArgDefaultValue1, {_defaultValue: false, _argType: 7 }],
	        statArgsLimitDefaultValue25 = [{}, arrayArgDefaultValue, doubleArgDefaultValue4];
	   
	
	   
	    defineBuiltInFunction('TREND', st_trend, 1, 4,
	        [{_argType: 4 , _valueType: 0 , _breakOnError: true}, {}, {},
	    ...
	    defineBuiltInFunction('FORECAST', st_forecast, 3, 3,
	        [doubleArgDefaultValue, arrayArgDefaultValue1, arrayArgDefaultValue1], '> 0', '> 0');
	    ...
	    defineBuiltInFunction('LARGE', st_large, 2, 2, statArgsLimitDefaultValue1, 0, 0);
	    defineBuiltInFunction('SMALL', st_small, 2, 2, statArgsLimitDefaultValue1, 0, 0);
	    defineBuiltInFunction('AVERAGEA', st_averagea, 1, keyword_undefined, arrayArgDefaultValue9, -1 , -1 );
	    defineBuiltInFunction('AVERAGEIF', st_averageif, 2, 3, keyword_undefined, [0, 2], [0, 2],
	        {_acceptsMissingArgument: 2});
	    defineBuiltInFunction('AVERAGEIFS', st_averageifs, 3, keyword_undefined, arrayArgDefaultValue, [0, '%= 1'], [0, '%= 1']);
	    ...
	    defineBuiltInFunction('COUNT', st_count, 1, keyword_undefined, keyword_undefined, -1 , -1 ,
	        {_acceptsError: -1 });
	    defineBuiltInFunction('COUNTA', st_counta, 1, keyword_undefined, keyword_undefined, -1 , -1 ,
	        {_acceptsError: -1 });
	    defineBuiltInFunction('COUNTBLANK', st_countblank, 1, 1, arrayArgDefaultValue5, -1 , -1 );
	    defineBuiltInFunction('COUNTIF', st_countif, 2, 2, [arrayArgDefaultValue5, arrayArgDefaultValue5], 0, 0);
	    defineBuiltInFunction('COUNTIFS', st_countifs, 2, keyword_undefined, arrayArgDefaultValue10, '%= 0', '%= 0');
	    ...
	    defineBuiltInFunction('LINEST', st_linest, 1, 4, statArgsLimitDefaultValue24,
	        [0, 1], [0, 1], {_acceptsMissingArgument: [1, 2, 3], _arrayArgumentEvaluateMode: 1 });
	    defineBuiltInFunction('SLOPE', st_slope, 2, 2, [arrayArgDefaultValue2, arrayArgDefaultValue2], -1 , -1 ,
	        {_arrayArgumentEvaluateMode: 1 });
	    defineBuiltInFunction('LOGEST', st_logest, 1, 4, statArgsLimitDefaultValue24,
	        [0, 1], [0, 1], {_acceptsMissingArgument: [1, 2, 3]});
	    defineBuiltInFunction('STEYX', st_steyx, 2, 2, statArgsLimitDefaultValue9, -1 , -1 );
	    defineBuiltInFunction('BETADIST', st_betadist, 3, 5,
	        [doubleArgDefaultValue, doubleArgDefaultValue3, doubleArgDefaultValue3, doubleArgDefaultValue4, doubleArgDefaultValue5],
	        keyword_undefined, keyword_undefined, {_acceptsMissingArgument: [3, 4]});
	    defineBuiltInFunction('BETA.DIST', st_deta_dist, 4, 6, [doubleArgDefaultValue, doubleArgDefaultValue3,
	            doubleArgDefaultValue3, boolArgDefaultValue, doubleArgDefaultValue4, doubleArgDefaultValue5],
	        keyword_undefined, keyword_undefined, {_acceptsMissingArgument: [5, 6]});
	    defineBuiltInFunction('BETAINV', st_betainv, 3, 5, statArgsLimitDefaultValue4, keyword_undefined,
	        keyword_undefined, {_acceptsMissingArgument: [3, 4]});
	    defineBuiltInFunction('BETA.INV', st_betainv, 3, 5, statArgsLimitDefaultValue4, keyword_undefined,
	        keyword_undefined, {_acceptsMissingArgument: [3, 4]});
	    ...
	    defineBuiltInFunction('NEGBINOMDIST', st_negbinomdist, 3, 3,
	        [stringIntArgDefaultValue, stringIntArgDefaultValue, doubleArgDefaultValue1]);
	    defineBuiltInFunction('NEGBINOM.DIST', st_negbinom_dist, 4, 4,
	        [stringIntArgDefaultValue2, stringIntArgDefaultValue1, doubleArgDefaultValue1, boolArgDefaultValue]);
	    ...
	    defineBuiltInFunction('CHISQ.INV.RT', st_chiinv, 2, 2, statArgsLimitDefaultValue8);
	    ...
	    defineBuiltInFunction('CORREL', st_correl, 2, 2, [arrayArgDefaultValue2, arrayArgDefaultValue2], -1 , -1 );
	    ...
	    defineBuiltInFunction('F.DIST', st_f_dist, 4, 4,
	        [doubleArgDefaultValue7, doubleArgDefaultValue8, doubleArgDefaultValue8, boolArgDefaultValue]);
	    ...
	    defineBuiltInFunction('HYPGEOMDIST', st_hypgeomdist, 4, 4,
	        [stringIntArgDefaultValue2, stringIntArgDefaultValue2, stringIntArgDefaultValue2, stringIntArgDefaultValue2]);
	    defineBuiltInFunction('HYPGEOM.DIST', st_hypgeom_dist, 5, 5,
	        [stringIntArgDefaultValue2, stringIntArgDefaultValue2, stringIntArgDefaultValue2, stringIntArgDefaultValue2, boolArgDefaultValue]);
	    defineBuiltInFunction('LOGNORMDIST', st_lognormdist, 3, 3, [doubleArgDefaultValue3, doubleArgDefaultValue, doubleArgDefaultValue3]);
	    defineBuiltInFunction('LOGNORM.DIST', st_lognorm_dist, 4, 4,
	        [doubleArgDefaultValue3, doubleArgDefaultValue, doubleArgDefaultValue3, boolArgDefaultValue]);
	    ...
	    defineBuiltInFunction('PROB', st_prob, 3, 4,
	        [arrayArgDefaultValue7, arrayArgDefaultValue1, doubleArgDefaultValue], [0, 1], [0, 1], {_acceptsMissingArgument: 3});
	    ...
	    defineBuiltInFunction('QUARTILE.EXC', st_quartileexc, 2, 2, [arrayArgDefaultValue, stringIntArgDefaultValue], 0, 0);
	    defineBuiltInFunction('RANK.AVG', st_rankavg, 2, 3, [arrayArgDefaultValue7, arrayArgDefaultValue6, doubleArgDefaultValue4],
	        [0, 1], 1, {_acceptsMissingArgument: 2});
...
/***/ })
/******/ ]);
//# sourceMappingURL=gc.spread.calcengine.advancedfunctions.12.0.0.js.map